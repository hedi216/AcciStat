...
with st.expander("🚻 Répartition par sexe"):
    if 'sexe' in df_fusion.columns:
...
with st.expander("📊 Répartition par tranche d'âge", expanded=True):
    if 'an_nais' in df_fusion.columns:
